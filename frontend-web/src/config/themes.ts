...
export type ThemeId = 'warm-orange' | 'midnight-blue' | 'rose-pink' | 'forest-green' | 'royal-purple' | 'graphite' | 'sunset' | 'custom'
...
/** 默认主题 */
export const DEFAULT_THEME_ID: ThemeId = 'warm-orange'
